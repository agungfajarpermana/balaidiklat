  ...
  <body class="bg-light">
    <div class="pos-f-t">
        ...
        <div class="bg-dark p-4">
          <div class="row">
            <div class="col-sm-3">
              ...
              <span class="text-muted">di halaman dashboard</span>
            </div>
            <div class="col-sm-6">
              <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white active" href="{{route('change.user.owner')}}">Ubah username</a>
                </li>
                <li class="nav-item">
      ...
      <nav class="navbar navbar-dark bg-secondary">
        ...
        <a class="nav-link text-white">Change Username</a>
      </nav>
    </div>
    <br>
      ...
      <div class="col-sm-6 offset-3">
        <form id="form_user">
          <div class="form-group">
            <label for="username">Username Lama</label>
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control input" name="newuser" id="newuser" placeholder="name@example.com">
            <small class="invalid-feedback text-danger newuser">
              
            </small>
          </div>
          <button type="submit" class="btn btn-success" id="changeuser">Ubah Username</button>
          {{csrf_field()}}
        </form>
      </div>
    </div>
